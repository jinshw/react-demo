    ...
    render() {
        ...
        return (
            <div className="siderbar">
                <h1 className="header-title" style={{cursor: 'pointer'}} onClick={this.handleClick}>后台管理系统</h1>
                <Menu
                    theme="dark"
                    style={{ width: 240 }}
                ...
                >
                    <SubMenu key="IndexPageManager" title={<span><Icon type="mail" /><span>功能演示</span></span>}>
                        ...
                        <Menu.Item key="ant-button">
                            <Link to="/index/button" activeStyle={ACTIVE}>ANTD BUTTON</Link>
                        </Menu.Item>
                        <Menu.Item key="couter">
                            <Link to="/index/counter" activeStyle={ACTIVE} >react-redux</Link>
                        </Menu.Item> 
                    </SubMenu>
